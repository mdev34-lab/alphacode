<p align="center">
  <a href="https://github.com/mdev34-lab/alphacode">
    <picture>
      ...
      <img src="packages/console/app/src/asset/logo-ornate-light.svg" alt="شعار alphacode">
    </picture>
  </a>
</p>
...
# مديري الحزم
npm i -g alphacode-ai@latest        # او bun/pnpm/yarn
scoop install alphacode             # Windows
choco install alphacode             # Windows
brew install mdev34-lab/alphacode/alphacode # macOS و Linux (موصى به، دائما محدث)
brew install alphacode              # macOS و Linux (صيغة brew الرسمية، تحديث اقل)
sudo pacman -S alphacode            # Arch Linux (Stable)
paru -S alphacode-bin               # Arch Linux (Latest from AUR)
mise use -g alphacode               # اي نظام
nix run nixpkgs#alphacode           # او github:mdev34-lab/alphacode لاحدث فرع dev
```
...
يتوفر alphacode ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/mdev34-lab/alphacode/releases) او من [alphacode.ai/download](https://github.com/mdev34-lab/alphacode).
...
يتضمن alphacode وكيليْن (Agents) مدمجين يمكنك التبديل بينهما باستخدام زر `Tab`.
...
تعرف على المزيد حول [agents](https://github.com/mdev34-lab/alphacode).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط alphacode، [**راجع التوثيق**](https://github.com/mdev34-lab/alphacode).

### المساهمة

اذا كنت مهتما بالمساهمة في alphacode، يرجى قراءة [contributing docs](./CONTRIBUTING.md) قبل ارسال pull request.

### البناء فوق alphacode

اذا كنت تعمل على مشروع مرتبط بـ alphacode ويستخدم "alphacode" كجزء من اسمه (مثل "alphacode-dashboard" او "alphacode-mobile")، يرجى اضافة ملاحظة في README توضح انه ليس مبنيا بواسطة فريق alphacode ولا يرتبط بنا بأي شكل.
