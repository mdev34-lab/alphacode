...
describe("ACP service sessions", () => {
    ...
    const sdk = {
      ...
      app: {
        agents: () =>
          Promise.resolve({
            data: [
              { name: "work", mode: "primary", permission: [], options: {} },
  ...
  it("does not cache failed directory snapshots", async () => {
    ...
    const sdk = {
      ...
      app: {
        agents: () => Promise.resolve({ data: [{ name: "work", mode: "primary", permission: [], options: {} }] }),
        skills: () => Promise.resolve({ data: [] }),
      },
      command: {
        list: () => Promise.resolve({ data: [] }),
  ...
  it("does not refetch providers modes or commands when switching effort from session snapshot", async () => {
    ...
    const sdk = {
      ...
      app: {
        agents: () => {
          calls.agents++
          return Promise.resolve({ data: [{ name: "work", mode: "primary", permission: [], options: {} }] })
        },
        skills: () => {
          calls.skills++
          return Promise.resolve({ data: [] })
