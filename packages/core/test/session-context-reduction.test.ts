...
// Reduction is the mechanism under test; the agent-facing pressure nudge is covered separately and
// would otherwise add system updates to every pressured turn below.
