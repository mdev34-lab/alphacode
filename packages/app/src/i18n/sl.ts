export const dict = {
  ...
  "desktop.menu.documentation": "alphacode Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "alphacode ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno alphacode se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "alphacode se ne odziva",
  ...
  "desktop.wsl.error.installalphacode": "Namestitev alphacode ni uspela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev alphacode je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja alphacode",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v alphacode.",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom alphacode se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingalphacode": "Preverjanje alphacode ...",
  "wsl.onboarding.checkingalphacodeIn": "Preverjanje alphacode v {{distro}} ...",
  "wsl.onboarding.updatingalphacode": "Posodabljanje alphacode ...",
  "wsl.onboarding.updatingalphacodeIn": "Posodabljanje alphacode v {{distro}} ...",
  "wsl.onboarding.updatealphacodeIn": "Posodobite alphacode v {{distro}}.",
  "wsl.onboarding.updatealphacode": "Posodobite alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode je pripravljen v {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode je pripravljen.",
  "wsl.onboarding.installalphacodeIn": "Namestite alphacode v {{distro}}.",
  "wsl.onboarding.installalphacode": "Namestite alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko alphacode doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "alphacode ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica alphacode ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi alphacode",
  ...
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, alphacode še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik alphacode znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za alphacode",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako alphacode izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali alphacode sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo alphacode.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene alphacode",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico alphacode.",
