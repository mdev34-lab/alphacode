export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do alphacode",
  ...
  "desktop.menu.ariaLabel": "Menu do alphacode",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o alphacode",
  "desktop.recovery.terminated": "A janela do alphacode foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O alphacode não está respondendo",
  ...
  "desktop.wsl.error.installalphacode": "Falha na instalação do alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "O alphacode não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do alphacode foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo alphacode",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no alphacode.",
  ...
  "dialog.server.description": "Trocar para qual servidor alphacode este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingalphacode": "Verificando o alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Verificando o alphacode em {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Atualizando o alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Atualizando o alphacode em {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Atualize o alphacode em {{distro}}.",
  "wsl.onboarding.updatealphacode": "Atualizar o alphacode",
  "wsl.onboarding.opencodeReadyIn": "O alphacode está pronto em {{distro}}.",
  "wsl.onboarding.opencodeReady": "O alphacode está pronto.",
  "wsl.onboarding.installalphacodeIn": "Instale o alphacode em {{distro}}.",
  "wsl.onboarding.installalphacode": "Instalar o alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o alphacode possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O alphacode não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o alphacode novamente.",
  ...
  "help.tabs.introduction": "Agora, o alphacode Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do alphacode ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do alphacode",
  ...
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: alphacode ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor alphacode dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do alphacode",
  ...
  "settings.general.row.appearance.description": "Personalize como o alphacode aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o alphacode segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o alphacode é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o alphacode iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do alphacode.",
