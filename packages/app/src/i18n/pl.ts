export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja alphacode",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać alphacode",
  "desktop.recovery.terminated": "Okno alphacode zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "alphacode nie odpowiada",
  ...
  "desktop.wsl.error.installalphacode": "Nie udało się zainstalować alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja alphacode została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez alphacode",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w alphacode.",
  ...
  "dialog.server.description": "Przełącz serwer alphacode, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingalphacode": "Sprawdzanie alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Sprawdzanie alphacode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Aktualizowanie alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Aktualizowanie alphacode w dystrybucji {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Zaktualizuj alphacode w dystrybucji {{distro}}.",
  "wsl.onboarding.updatealphacode": "Zaktualizuj alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode jest gotowy.",
  "wsl.onboarding.installalphacodeIn": "Zainstaluj alphacode w dystrybucji {{distro}}.",
  "wsl.onboarding.installalphacode": "Zainstaluj alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim alphacode będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "alphacode nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja alphacode ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu alphacode",
  ...
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: alphacode nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "alphacode zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer alphacode wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla alphacode",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd alphacode na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy alphacode ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw alphacode.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania alphacode",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji alphacode.",
