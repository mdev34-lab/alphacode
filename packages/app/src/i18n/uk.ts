export const dict = {
  ...
  "desktop.menu.documentation": "Документація alphacode",
  ...
  "desktop.menu.ariaLabel": "Меню alphacode",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити alphacode",
  "desktop.recovery.terminated": "Роботу вікна alphacode несподівано завершено",
  "desktop.recovery.unresponsive": "alphacode не відповідає",
  ...
  "desktop.wsl.error.installalphacode": "Не вдалося встановити alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення alphacode завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від alphacode",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у alphacode.",
  ...
  "dialog.server.description": "Перемкніть сервер alphacode, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingalphacode": "Перевірка alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Перевірка alphacode у {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Оновлення alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Оновлення alphacode у {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Оновіть alphacode у {{distro}}.",
  "wsl.onboarding.updatealphacode": "Оновити alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode готовий до роботи у {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode готовий до роботи.",
  "wsl.onboarding.installalphacodeIn": "Встановіть alphacode у {{distro}}.",
  "wsl.onboarding.installalphacode": "Встановити alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в alphacode потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "alphacode не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія alphacode ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді alphacode",
  ...
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, alphacode ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер alphacode всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу alphacode",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд alphacode на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи alphacode використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему alphacode.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску alphacode",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію alphacode.",
