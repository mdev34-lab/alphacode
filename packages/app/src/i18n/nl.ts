export const dict = {
  ...
  "desktop.menu.documentation": "alphacode-documentatie",
  ...
  "desktop.recovery.loadFailed": "alphacode kan niet worden geladen",
  "desktop.recovery.terminated": "Het alphacode-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "alphacode reageert niet",
  ...
  "desktop.wsl.error.installalphacode": "Installatie van alphacode is mislukt",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De alphacode-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door alphacode",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in alphacode te gebruiken.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in alphacode te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in alphacode te gebruiken.",
  ...
  "dialog.server.description": "Wijzig met welke alphacode-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingalphacode": "alphacode controleren...",
  "wsl.onboarding.checkingalphacodeIn": "alphacode controleren in {{distro}}...",
  "wsl.onboarding.updatingalphacode": "alphacode bijwerken...",
  "wsl.onboarding.updatingalphacodeIn": "alphacode bijwerken in {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Werk alphacode bij in {{distro}}.",
  "wsl.onboarding.updatealphacode": "alphacode bijwerken",
  "wsl.onboarding.opencodeReadyIn": "alphacode is gereed in {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode is klaar.",
  "wsl.onboarding.installalphacodeIn": "Installeer alphacode in {{distro}}.",
  "wsl.onboarding.installalphacode": "Installeer alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat alphacode een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "alphacode kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens alphacode opnieuw.",
  ...
  "help.tabs.introduction": "alphacode Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van alphacode ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het alphacode-team",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: alphacode ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "alphacode bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de alphacode-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor alphacode",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe alphacode eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of alphacode het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van alphacode aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer alphacode wordt gestart",
  ...
  "settings.updates.toast.latest.title": "alphacode is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van alphacode.",
