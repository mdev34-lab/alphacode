...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von alphacode",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in alphacode zu nutzen.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in alphacode zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in alphacode zu nutzen.",
  ...
  "dialog.server.description": "Wechseln Sie den alphacode-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.opencode": "alphacode",
  ...
  "wsl.onboarding.checkingalphacode": "alphacode wird geprüft…",
  "wsl.onboarding.checkingalphacodeIn": "alphacode in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingalphacode": "alphacode wird aktualisiert…",
  "wsl.onboarding.updatingalphacodeIn": "alphacode in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updatealphacodeIn": "Aktualisieren Sie alphacode in {{distro}}.",
  "wsl.onboarding.updatealphacode": "alphacode aktualisieren",
  "wsl.onboarding.opencodeReadyIn": "alphacode ist in {{distro}} bereit.",
  "wsl.onboarding.opencodeReady": "alphacode ist bereit.",
  "wsl.onboarding.installalphacodeIn": "Installieren Sie alphacode in {{distro}}.",
  "wsl.onboarding.installalphacode": "alphacode installieren",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor alphacode einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "alphacode konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann alphacode erneut.",
  ...
  "toast.update.description": "Eine neue Version von alphacode ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem alphacode-Team",
  ...
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: alphacode unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "alphacode mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "alphacode enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "alphacode Desktop",
  ...
  "settings.desktop.wsl.description": "alphacode-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für alphacode ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie alphacode auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob alphacode dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von alphacode anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von alphacode automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "alphacode ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von alphacode wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "alphacode konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das alphacode-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "alphacode reagiert nicht",
  ...
  "desktop.wsl.error.installalphacode": "alphacode-Installation fehlgeschlagen",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das alphacode-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "alphacode Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
