export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af alphacode",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i alphacode.",
  ...
  "dialog.server.description": "Skift hvilken alphacode-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingalphacode": "Tjekker alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Tjekker alphacode i {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Opdaterer alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Opdaterer alphacode i {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Opdater alphacode i {{distro}}.",
  "wsl.onboarding.updatealphacode": "Opdater alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før alphacode kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "alphacode kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter alphacode igen.",
  ...
  "toast.update.description": "En ny version af alphacode ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til alphacode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, alphacode understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "alphacode inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør alphacode-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for alphacode",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan alphacode ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om alphacode skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas alphacodes tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når alphacode starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af alphacode.",
  ...
  "desktop.recovery.loadFailed": "alphacode kunne ikke indlæses",
  "desktop.recovery.terminated": "alphacode-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installalphacode": "Installationen af alphacode mislykkedes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af alphacode er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "alphacode Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
