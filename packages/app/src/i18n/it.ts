export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da alphacode",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in alphacode.",
  ...
  "dialog.server.description": "Cambia il server alphacode a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingalphacode": "Controllo alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Controllo alphacode in {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Aggiornamento alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Aggiornamento alphacode in {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Aggiorna alphacode in {{distro}}.",
  "wsl.onboarding.updatealphacode": "Aggiorna alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode è pronto in {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode è pronto.",
  "wsl.onboarding.installalphacodeIn": "Installa alphacode in {{distro}}.",
  "wsl.onboarding.installalphacode": "Installa alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che alphacode possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "alphacode non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di alphacode ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team alphacode",
  ...
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: alphacode non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server alphacode all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per alphacode",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di alphacode sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se alphacode segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di alphacode.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di alphacode",
  ...
  "settings.updates.toast.latest.title": "alphacode è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di alphacode.",
  ...
  "desktop.menu.documentation": "Documentazione di alphacode",
  ...
  "desktop.menu.ariaLabel": "Menu alphacode",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare alphacode",
  "desktop.recovery.terminated": "La finestra di alphacode si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "alphacode non risponde",
  ...
  "desktop.wsl.error.installalphacode": "Installazione di alphacode non riuscita",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di alphacode è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
