...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacode yüklenemedi",
  "desktop.recovery.terminated": "alphacode penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "alphacode yanıt vermiyor",
  ...
  "desktop.wsl.error.installalphacode": "alphacode kurulamadı",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "alphacode güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "alphacode tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve alphacode'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak alphacode'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak alphacode'da {{provider}} modellerini kullanın.",
  ...
  "dialog.server.description": "Bu uygulamanın hangi alphacode sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingalphacode": "alphacode kontrol ediliyor...",
  "wsl.onboarding.checkingalphacodeIn": "{{distro}} içinde alphacode kontrol ediliyor...",
  "wsl.onboarding.updatingalphacode": "alphacode güncelleniyor...",
  "wsl.onboarding.updatingalphacodeIn": "{{distro}} içinde alphacode güncelleniyor...",
  "wsl.onboarding.updatealphacodeIn": "{{distro}} içindeki alphacode'u güncelleyin.",
  "wsl.onboarding.updatealphacode": "alphacode'u güncelle",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} içinde alphacode hazır.",
  "wsl.onboarding.opencodeReady": "alphacode hazır.",
  "wsl.onboarding.installalphacodeIn": "alphacode'u {{distro}} içine kurun.",
  "wsl.onboarding.installalphacode": "alphacode'u kur",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "alphacode'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "alphacode bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından alphacode'u tekrar açın.",
  ...
  "help.tabs.introduction": "alphacode Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "alphacode'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı alphacode ekibine",
  ...
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: alphacode henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "alphacode ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "alphacode Masaüstü",
  ...
  "settings.desktop.wsl.description": "alphacode sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "alphacode'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "alphacode'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "alphacode'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "alphacode'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "alphacode başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "alphacode'un en son sürümünü kullanıyorsunuz.",
