...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacode 加载失败",
  "desktop.recovery.terminated": "alphacode 窗口意外终止",
  "desktop.recovery.unresponsive": "alphacode 未响应",
  ...
  "desktop.wsl.error.installalphacode": "alphacode 安装失败",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}} 中未安装 alphacode",
  "desktop.wsl.error.updateVersion":
    "alphacode 更新已完成，但 {{distro}} 仍报告版本 {{installed}}；预期版本为 {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "alphacode 提供的免费模型",
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接账户，并在 alphacode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.opencodeZen.line1": "alphacode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的账户并在 alphacode 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix": " 并输入以下代码，以连接你的账户并在 alphacode 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切换此应用连接的 alphacode 服务器。",
  ...
  "wsl.onboarding.checkingalphacode": "正在检查 alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "正在检查 {{distro}} 中的 alphacode...",
  "wsl.onboarding.updatingalphacode": "正在更新 alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "正在更新 {{distro}} 中的 alphacode...",
  "wsl.onboarding.updatealphacodeIn": "更新 {{distro}} 中的 alphacode。",
  "wsl.onboarding.updatealphacode": "更新 alphacode",
  "wsl.onboarding.opencodeReadyIn": "{{distro}} 中的 alphacode 已就绪。",
  "wsl.onboarding.opencodeReady": "alphacode 已就绪。",
  "wsl.onboarding.installalphacodeIn": "在 {{distro}} 中安装 alphacode。",
  "wsl.onboarding.installalphacode": "安装 alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "未安装 alphacode",
  ...
  "wsl.onboarding.wslNotInstalled.description": "alphacode 需要 WSL（Windows Subsystem for Linux）才能添加 WSL 服务器",
  "wsl.onboarding.wslUnavailable.title": "WSL 不可用",
  "wsl.onboarding.wslUnavailable.description": "alphacode 无法验证此设备上的 WSL。",
  "wsl.onboarding.installWsl": "安装 WSL",
  "wsl.onboarding.windowsRestartRequired": "重启 Windows 以完成 WSL 安装，然后重新打开 alphacode。",
  ...
  "help.tabs.introduction": "alphacode Desktop 现已采用以标签页为核心的设计。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "alphacode 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 alphacode 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意：alphacode 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "alphacode 提供免费模型，你可以立即开始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 alphacode 服务器。",
  ...
  "settings.general.row.language.description": "更改 alphacode 的显示语言",
  ...
  "settings.general.row.appearance.description": "自定义 alphacode 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 alphacode 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 alphacode 的主题。",
  ...
  "settings.updates.row.startup.description": "在 alphacode 启动时自动检查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 alphacode。",
