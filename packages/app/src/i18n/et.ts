export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacode laadimine ebaõnnestus",
  "desktop.recovery.terminated": "alphacode aken suleti ootamatult",
  "desktop.recovery.unresponsive": "alphacode ei vasta",
  ...
  "desktop.wsl.error.installalphacode": "alphacode installimine ebaõnnestus",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "alphacode värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub alphacode",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid alphacode'is.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises alphacode.",
  ...
  "dialog.server.description": "Lülitage, millise alphacode serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingalphacode": "alphacode kontrollimine...",
  "wsl.onboarding.checkingalphacodeIn": "alphacode kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingalphacode": "alphacode värskendamine...",
  "wsl.onboarding.updatingalphacodeIn": "alphacode värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Värskenda alphacode jaotises {{distro}}.",
  "wsl.onboarding.updatealphacode": "Värskenda alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode on valmis {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode on valmis.",
  "wsl.onboarding.installalphacodeIn": "Installige alphacode asukohta {{distro}}.",
  "wsl.onboarding.installalphacode": "Installige alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui alphacode saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "alphacode ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti alphacode.",
  ...
  "help.tabs.introduction": "alphacode Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse alphacode ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast alphacode meeskonnale",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, alphacode ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "alphacode sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "alphacode Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage alphacode server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke alphacode kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas alphacode teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas alphacode järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas alphacode on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui alphacode käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse alphacode uusimat versiooni.",
