...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða alphacode",
  "alphacode-glugganum var óvænt lokað",
  "alphacode svarar ekki",
  ...
  "alphacode er ekki uppsett í {{distro}}",
  "Uppfærslu alphacode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá alphacode",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í alphacode.",
  ...
  "dialog.server.description": "Skiptu um hvaða alphacode miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingalphacode": "Athugar alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Athugar alphacode í {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Uppfærir alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Uppfærir alphacode í {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Uppfærðu alphacode í {{distro}}.",
  "wsl.onboarding.updatealphacode": "Uppfærðu alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode er tilbúið í {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode er tilbúinn.",
  "wsl.onboarding.installalphacodeIn": "Settu upp alphacode í {{distro}}.",
  "wsl.onboarding.installalphacode": "Settu upp alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en alphacode getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "alphacode gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan alphacode aftur.",
  ...
  "help.tabs.introduction": "alphacode Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af alphacode ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til alphacode teymisins",
  ...
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, alphacode styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "alphacode inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "alphacode skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu alphacode netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir alphacode",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig alphacode lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort alphacode fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig alphacode er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar alphacode ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af alphacode.",
