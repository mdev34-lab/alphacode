...
export const dict = {
  ...
  "desktop.menu.documentation": "alphacode-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "alphacode-meny",
  ...
  "desktop.recovery.loadFailed": "alphacode kunne ikke lastes inn",
  "desktop.recovery.terminated": "alphacode-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "alphacode svarer ikke",
  ...
  "desktop.wsl.error.installalphacode": "Installasjonen av alphacode mislyktes",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av alphacode er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av alphacode",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i alphacode.",
  ...
  "dialog.server.description": "Bytt hvilken alphacode-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av alphacode ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til alphacode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at alphacode ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "alphacode inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør alphacode-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for alphacode",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan alphacode ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om alphacode skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i alphacode.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når alphacode starter",
  ...
  "settings.updates.toast.latest.title": "alphacode er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av alphacode.",
  ...
  "wsl.onboarding.checkingalphacode": "Sjekker alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Sjekker alphacode i {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Oppdaterer alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Oppdaterer alphacode i {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Oppdater alphacode i {{distro}}.",
  "wsl.onboarding.updatealphacode": "Oppdater alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode er klar i {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode er klar.",
  "wsl.onboarding.installalphacodeIn": "Installer alphacode i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før alphacode kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "alphacode kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter alphacode på nytt.",
  ...
  "help.tabs.introduction": "alphacode Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
