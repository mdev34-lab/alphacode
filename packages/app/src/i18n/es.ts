export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de alphacode",
  ...
  "desktop.menu.ariaLabel": "Menú de alphacode",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar alphacode",
  "desktop.recovery.terminated": "La ventana de alphacode se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "alphacode no responde",
  ...
  "desktop.wsl.error.installalphacode": "No se pudo instalar alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de alphacode finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por alphacode",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en alphacode.",
  ...
  "dialog.server.description": "Cambiar el servidor de alphacode al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingalphacode": "Comprobando alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Comprobando alphacode en {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Actualizando alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Actualizando alphacode en {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Actualiza alphacode en {{distro}}.",
  "wsl.onboarding.updatealphacode": "Actualizar alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode está listo en {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode está listo.",
  "wsl.onboarding.installalphacodeIn": "Instala alphacode en {{distro}}.",
  "wsl.onboarding.installalphacode": "Instalar alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que alphacode pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "alphacode no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de alphacode ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de alphacode",
  ...
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: alphacode aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor alphacode dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para alphacode",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve alphacode en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si alphacode sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de alphacode.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia alphacode",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de alphacode.",
