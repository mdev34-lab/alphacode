...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "alphacode se nije uspio učitati",
  "Prozor aplikacije alphacode neočekivano je zatvoren",
  "alphacode ne reagira",
  ...
  "Instalacija aplikacije alphacode nije uspjela",
  ...
  "alphacode nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije alphacode je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi alphacode",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u alphacode.",
  ...
  "dialog.server.description": "Promijenite na koji se alphacode poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingalphacodeIn": "Provjera alphacode u {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Ažuriranje alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Ažuriranje alphacode u {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Ažurirajte alphacode u {{distro}}.",
  "wsl.onboarding.updatealphacode": "Ažurirajte alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode je spreman u {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode je spreman.",
  "wsl.onboarding.installalphacodeIn": "Instalirajte alphacode u {{distro}}.",
  "wsl.onboarding.installalphacode": "Instalirajte alphacode",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što alphacode može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "alphacode nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite alphacode.",
  ...
  "help.tabs.introduction": "Radna površina alphacode sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija alphacode ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku alphacode timu",
  ...
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, alphacode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "alphacode uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "alphacode Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite alphacode poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za alphacode",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako alphacode izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li alphacode slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je alphacode tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se alphacode pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju alphacode.",
