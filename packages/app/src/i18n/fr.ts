export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'alphacode",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'alphacode",
  "desktop.recovery.terminated": "La fenêtre alphacode s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "alphacode ne répond pas",
  ...
  "desktop.wsl.error.installalphacode": "Échec de l'installation d'alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'alphacode est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par alphacode",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans alphacode.",
  ...
  "dialog.server.description": "Changez le serveur alphacode auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingalphacode": "Vérification d'alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Vérification d'alphacode dans {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Mise à jour d'alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Mise à jour d'alphacode dans {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Mettez à jour alphacode dans {{distro}}.",
  "wsl.onboarding.updatealphacode": "Mettre à jour alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode est prêt dans {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode est prêt.",
  "wsl.onboarding.installalphacodeIn": "Installez alphacode dans {{distro}}.",
  "wsl.onboarding.installalphacode": "Installer alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'alphacode puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "alphacode n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'alphacode ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe alphacode",
  ...
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'alphacode ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "alphacode inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur alphacode dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour alphacode",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'alphacode sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si alphacode suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'alphacode.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'alphacode",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'alphacode.",
