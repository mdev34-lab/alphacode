export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacodeを読み込めませんでした",
  "desktop.recovery.terminated": "alphacodeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "alphacodeが応答していません",
  ...
  "desktop.wsl.error.installalphacode": "alphacodeのインストールに失敗しました",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "{{distro}}にはalphacodeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "alphacodeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.model.unpaid.freeModels.title": "alphacodeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、alphacodeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してalphacodeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、alphacodeで{{provider}}モデルを使用してください。",
  ...
  "dialog.server.description": "このアプリが接続するalphacodeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingalphacode": "alphacodeを確認中...",
  "wsl.onboarding.checkingalphacodeIn": "{{distro}}内のalphacodeを確認中...",
  "wsl.onboarding.updatingalphacode": "alphacodeを更新中...",
  "wsl.onboarding.updatingalphacodeIn": "{{distro}}内のalphacodeを更新中...",
  "wsl.onboarding.updatealphacodeIn": "{{distro}}内のalphacodeを更新してください。",
  "wsl.onboarding.updatealphacode": "alphacodeを更新",
  "wsl.onboarding.opencodeReadyIn": "{{distro}}内のalphacodeの準備ができました。",
  "wsl.onboarding.opencodeReady": "alphacodeの準備ができました。",
  "wsl.onboarding.installalphacodeIn": "{{distro}}にalphacodeをインストールしてください。",
  "wsl.onboarding.installalphacode": "alphacodeをインストール",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacodeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "alphacodeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、alphacodeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "alphacode Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "alphacodeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをalphacodeチームに報告してください: ",
  ...
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: alphacodeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "alphacodeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でalphacodeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "alphacodeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのalphacodeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "alphacodeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "alphacodeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "alphacode の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "alphacode は最新バージョンです。",
