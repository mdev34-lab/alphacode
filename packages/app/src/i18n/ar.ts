export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل alphacode",
  "desktop.recovery.terminated": "توقفت نافذة alphacode بشكل غير متوقع",
  "desktop.recovery.unresponsive": "alphacode لا يستجيب",
  ...
  "desktop.wsl.error.installalphacode": "فشل تثبيت alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث alphacode، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من alphacode",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "يمنحك alphacode Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في alphacode.",
  ...
  "dialog.server.description": "تبديل خادم alphacode الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingalphacode": "جارٍ التحقق من alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "جارٍ التحقق من alphacode في {{distro}}...",
  "wsl.onboarding.updatingalphacode": "جارٍ تحديث alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "جارٍ تحديث alphacode في {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "حدّث alphacode في {{distro}}.",
  "wsl.onboarding.updatealphacode": "تحديث alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode جاهز في {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode جاهز.",
  "wsl.onboarding.installalphacodeIn": "ثبّت alphacode في {{distro}}.",
  "wsl.onboarding.installalphacode": "تثبيت alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن alphacode من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على alphacode التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح alphacode.",
  ...
  "help.tabs.introduction": "أصبح alphacode Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من alphacode ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق alphacode",
  ...
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن alphacode لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن alphacode نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم alphacode داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ alphacode",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور alphacode على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان alphacode يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة alphacode.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل alphacode",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من alphacode.",
