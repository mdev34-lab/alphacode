export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "alphacoden tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja alphacodessa.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja alphacodessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja alphacodessa.",
  ...
  "dialog.server.description": "Vaihda alphacode-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingalphacode": "Tarkistetaan alphacodea...",
  "wsl.onboarding.checkingalphacodeIn": "Tarkistetaan alphacodea kohteessa {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Päivitetään alphacodea...",
  "wsl.onboarding.updatingalphacodeIn": "Päivitetään alphacodea kohteessa {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Päivitä alphacode jakelussa {{distro}}.",
  "wsl.onboarding.updatealphacode": "Päivitä alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode on valmis jakelussa {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode on valmis.",
  "wsl.onboarding.installalphacodeIn": "Asenna alphacode jakeluun {{distro}}.",
  "wsl.onboarding.installalphacode": "Asenna alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacodea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin alphacode voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "alphacode ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten alphacode uudelleen.",
  ...
  "toast.update.description": "alphacoden uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä alphacode-tiimille",
  ...
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että alphacode ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "alphacode sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita alphacode-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda alphacoden näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä alphacode näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö alphacode järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta alphacoden teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun alphacode käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät alphacoden uusinta versiota.",
  ...
  "desktop.menu.documentation": "alphacode-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "alphacode-valikko",
  ...
  "desktop.recovery.loadFailed": "alphacoden lataaminen epäonnistui",
  "desktop.recovery.terminated": "alphacode-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "alphacode ei vastaa",
  ...
  "desktop.wsl.error.installalphacode": "alphacoden asennus epäonnistui",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacodea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "alphacoden päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "alphacode Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
