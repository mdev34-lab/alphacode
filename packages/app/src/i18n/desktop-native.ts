...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "alphacode failed to load",
  "desktop.recovery.terminated": "alphacode window terminated unexpectedly",
  "desktop.recovery.unresponsive": "alphacode is not responding",
  ...
  "desktop.wsl.error.installalphacode": "alphacode installation failed",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "alphacode update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
