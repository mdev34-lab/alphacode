export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacode yüklənə bilmədi",
  "desktop.recovery.terminated": "alphacode pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "alphacode cavab vermir",
  ...
  "desktop.wsl.error.installalphacode": "alphacode quraşdırılması uğursuz oldu",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "alphacode yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "alphacode tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və alphacode-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və alphacode-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və alphacode-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu alphacode serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingalphacode": "alphacode yoxlanılır...",
  "wsl.onboarding.checkingalphacodeIn": "{{distro}}-də alphacode yoxlanılır...",
  "wsl.onboarding.updatingalphacode": "alphacode yenilənir...",
  "wsl.onboarding.updatingalphacodeIn": "{{distro}}-də alphacode yenilənir...",
  "wsl.onboarding.updatealphacodeIn": "{{distro}}-də alphacode-u yeniləyin.",
  "wsl.onboarding.updatealphacode": "alphacode-u yeniləyin",
  "wsl.onboarding.opencodeReadyIn": "alphacode {{distro}}-də hazırdır.",
  "wsl.onboarding.opencodeReady": "alphacode hazırdır.",
  "wsl.onboarding.installalphacodeIn": "alphacode-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installalphacode": "alphacode quraşdırın",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "alphacode WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "alphacode bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra alphacode-u yenidən açın.",
  ...
  "help.tabs.introduction": "alphacode Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "alphacode-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı alphacode komandasına",
  ...
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: alphacode hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "alphacode-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində alphacode serverini işlət.",
  ...
  "settings.general.row.language.description": "alphacode üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "alphacode-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "alphacode-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "alphacode-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "alphacode açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "alphacode-un ən son versiyasından istifadə edirsiniz.",
