export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacode kunde inte läsas in",
  "desktop.recovery.terminated": "alphacode-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "alphacode svarar inte",
  ...
  "desktop.wsl.error.installalphacode": "Installationen av alphacode misslyckades",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "alphacode-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av alphacode",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i alphacode.",
  ...
  "dialog.server.description": "Växla vilken alphacode-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingalphacode": "Kontrollerar alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Kontrollerar alphacode i {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Uppdaterar alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Uppdaterar alphacode i {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Uppdatera alphacode i {{distro}}.",
  "wsl.onboarding.updatealphacode": "Uppdatera alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode är redo i {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode är redo.",
  "wsl.onboarding.installalphacodeIn": "Installera alphacode i {{distro}}.",
  "wsl.onboarding.installalphacode": "Installera alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan alphacode kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "alphacode kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan alphacode igen.",
  ...
  "help.tabs.introduction": "alphacode Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av alphacode ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till alphacode-teamet",
  ...
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, alphacode stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "alphacode innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör alphacode-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för alphacode",
  ...
  "settings.general.row.appearance.description": "Anpassa hur alphacode ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om alphacode följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa alphacodes tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när alphacode startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av alphacode.",
