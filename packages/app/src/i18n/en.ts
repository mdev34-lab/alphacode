...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by alphacode",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in alphacode.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.opencodeZen.line1":
    "alphacode Zen gives you access to a curated set of reliable optimized models for coding agents.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in alphacode.",
  ...
  "dialog.server.description": "Switch which alphacode server this app connects to.",
  ...
  "wsl.onboarding.checkingalphacode": "Checking alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Checking alphacode in {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Updating alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Updating alphacode in {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Update alphacode in {{distro}}.",
  "wsl.onboarding.updatealphacode": "Update alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode is ready in {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode is ready.",
  "wsl.onboarding.installalphacodeIn": "Install alphacode in {{distro}}.",
  "wsl.onboarding.installalphacode": "Install alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before alphacode can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "alphacode could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of alphacode ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the alphacode team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, alphacode does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "alphacode includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the alphacode server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for alphacode",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how alphacode looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether alphacode follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how alphacode is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when alphacode launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of alphacode.",
