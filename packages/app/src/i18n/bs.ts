export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za alphacode",
  ...
  "desktop.menu.ariaLabel": "alphacode meni",
  ...
  "desktop.recovery.loadFailed": "alphacode se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor alphacode-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "alphacode ne reaguje",
  ...
  "desktop.wsl.error.installalphacode": "Instalacija alphacode-a nije uspjela",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje alphacode-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje alphacode",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u alphacode-u.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u alphacode-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u alphacode-u.",
  ...
  "dialog.server.description": "Promijeni na koji se alphacode server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingalphacode": "Provjera alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Provjera alphacode u distribuciji {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Ažuriranje alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Ažuriranje alphacode u distribuciji {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Ažuriraj alphacode u distribuciji {{distro}}.",
  "wsl.onboarding.updatealphacode": "Ažuriraj alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode je spreman.",
  "wsl.onboarding.installalphacodeIn": "Instaliraj alphacode u distribuciji {{distro}}.",
  "wsl.onboarding.installalphacode": "Instaliraj alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi alphacode mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "alphacode nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija alphacode-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku alphacode timu",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: alphacode još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "alphacode uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni alphacode server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u alphacode-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako alphacode izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li alphacode prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu alphacode-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se alphacode pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju alphacode-a.",
