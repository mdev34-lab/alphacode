export const dict = {
  ...
  "desktop.recovery.loadFailed": "alphacode gagal dimuat",
  "desktop.recovery.terminated": "Jendela alphacode berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "alphacode tidak merespons",
  ...
  "desktop.wsl.error.installalphacode": "Instalasi alphacode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan alphacode selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh alphacode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di alphacode.",
  ...
  "dialog.server.description": "Ganti server alphacode mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingalphacode": "Memeriksa alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Memeriksa alphacode di {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Memperbarui alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Memperbarui alphacode di {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Perbarui alphacode di {{distro}}.",
  "wsl.onboarding.updatealphacode": "Perbarui alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode siap di {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode siap.",
  "wsl.onboarding.installalphacodeIn": "Instal alphacode di {{distro}}.",
  "wsl.onboarding.installalphacode": "Instal alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum alphacode dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "alphacode tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru alphacode ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim alphacode",
  ...
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: alphacode belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server alphacode di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk alphacode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan alphacode di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah alphacode mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat alphacode diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru alphacode.",
