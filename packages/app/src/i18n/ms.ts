export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi alphacode",
  ...
  "desktop.recovery.loadFailed": "alphacode gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap alphacode ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "alphacode tidak memberi respons",
  ...
  "desktop.wsl.error.installalphacode": "Pemasangan alphacode gagal",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini alphacode selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh alphacode",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam alphacode.",
  ...
  "dialog.server.description": "Tukar pelayan alphacode yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingalphacode": "Sedang menyemak alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Sedang menyemak alphacode dalam {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Sedang mengemas kini alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Sedang mengemas kini alphacode dalam {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Kemas kini alphacode dalam {{distro}}.",
  "wsl.onboarding.updatealphacode": "Kemas kini alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode sedia digunakan.",
  "wsl.onboarding.installalphacodeIn": "Pasang alphacode dalam {{distro}}.",
  "wsl.onboarding.installalphacode": "Pasang alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum alphacode boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "alphacode tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu alphacode ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan alphacode",
  ...
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, alphacode belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan alphacode dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk alphacode",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa alphacode pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada alphacode mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema alphacode.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila alphacode dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini alphacode.",
