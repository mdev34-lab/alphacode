export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu alphacode",
  ...
  "desktop.recovery.loadFailed": "Không tải được alphacode",
  "desktop.recovery.terminated": "Cửa sổ alphacode đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "alphacode không phản hồi",
  ...
  "desktop.wsl.error.installalphacode": "Không cài đặt được alphacode",
  ...
  "desktop.wsl.error.opencodeNotInstalled": "alphacode chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật alphacode nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do alphacode cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong alphacode.",
  ...
  "dialog.server.description": "Chuyển máy chủ alphacode mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingalphacode": "Đang kiểm tra alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Đang kiểm tra alphacode trong {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Đang cập nhật alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Đang cập nhật alphacode trong {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Cập nhật alphacode trong {{distro}}.",
  "wsl.onboarding.updatealphacode": "Cập nhật alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode đã sẵn sàng.",
  "wsl.onboarding.installalphacodeIn": "Cài đặt alphacode trong {{distro}}.",
  "wsl.onboarding.installalphacode": "Cài đặt alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi alphacode có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "alphacode không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của alphacode ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm alphacode",
  ...
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: alphacode chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "alphacode bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ alphacode bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho alphacode",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của alphacode trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem alphacode tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của alphacode.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi alphacode khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của alphacode.",
