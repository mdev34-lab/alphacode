export const dict = {
  ...
  "desktop.menu.documentation": "alphacode hujjatlari",
  ...
  "desktop.menu.ariaLabel": "alphacode menyusi",
  ...
  "desktop.recovery.loadFailed": "alphacode yuklanmadi",
  "desktop.recovery.terminated": "alphacode oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "alphacode javob bermayapti",
  ...
  "desktop.wsl.error.installalphacode": "alphacode oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.opencodeMissing": "alphacode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.opencodeCannotRun": "opencode o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.opencodeNotInstalled": "alphacode {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "alphacode yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.model.unpaid.freeModels.title": "alphacode tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va alphacode’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va alphacode da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va alphacode da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.server.description": "Ushbu ilova qaysi alphacode serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingalphacode": "alphacode tekshirilmoqda...",
  "wsl.onboarding.checkingalphacodeIn": "alphacode {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingalphacode": "alphacode yangilanmoqda...",
  "wsl.onboarding.updatingalphacodeIn": "alphacode {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updatealphacodeIn": "alphacode-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updatealphacode": "alphacode-ni yangilang",
  "wsl.onboarding.opencodeReadyIn": "alphacode {{distro}} da tayyor.",
  "wsl.onboarding.opencodeReady": "alphacode tayyor.",
  "wsl.onboarding.installalphacodeIn": "alphacode-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installalphacode": "alphacode-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "alphacode WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "alphacode WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra alphacode-ni qayta oching.",
  ...
  "help.tabs.introduction": "alphacode Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "alphacode ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida alphacode jamoasiga xabar bering",
  ...
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, alphacode hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "alphacode bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi alphacode serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "alphacode uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "alphacode qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "alphacode tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "alphacode mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "alphacode ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz alphacode oxirgi versiyasini ishga tushiryapsiz.",
