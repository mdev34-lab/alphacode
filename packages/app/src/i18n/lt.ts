...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "alphacode įkelti nepavyko",
  "alphacode langas netikėtai užsidarė",
  "alphacode neatsako",
  ...
  "alphacode įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "opencode šiame distributyve neįdiegtas",
  "opencode įdiegtas, bet jo paleisti nepavyko",
  "alphacode neįdiegtas distributyve {{distro}}",
  "alphacode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami alphacode modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje alphacode.",
  ...
  "provider.connect.opencodeZen.line1":
    "alphacode Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius alphacode.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius alphacode.",
  ...
  "dialog.server.description": "Perjunkite, prie kurio alphacode serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingalphacode": "Tikrinama alphacode...",
  "wsl.onboarding.checkingalphacodeIn": "Tikrinama alphacode {{distro}}...",
  "wsl.onboarding.updatingalphacode": "Atnaujinamas alphacode...",
  "wsl.onboarding.updatingalphacodeIn": "Atnaujinamas alphacode {{distro}}...",
  "wsl.onboarding.updatealphacodeIn": "Atnaujinkite alphacode {{distro}}.",
  "wsl.onboarding.updatealphacode": "Atnaujinkite alphacode",
  "wsl.onboarding.opencodeReadyIn": "alphacode yra paruoštas {{distro}}.",
  "wsl.onboarding.opencodeReady": "alphacode yra paruoštas.",
  "wsl.onboarding.installalphacodeIn": "Įdiekite alphacode į {{distro}}.",
  "wsl.onboarding.installalphacode": "Įdiekite alphacode",
  ...
  "wsl.onboarding.distroStatus.opencodeMissing": "alphacode neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad alphacode galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "alphacode nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite alphacode.",
  ...
  "help.tabs.introduction": "alphacode Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują alphacode ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą alphacode komandai",
  ...
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad alphacode dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "alphacode apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "alphacode darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite alphacode serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite alphacode ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip alphacode atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar alphacode seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite alphacode temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas alphacode",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią alphacode versiją.",
