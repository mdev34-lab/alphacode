...
type Endpoint3_8Request = Parameters<RawClient["server.session"]["session.compress"]>[0]
type Endpoint3_8Input = {
  readonly sessionID: Endpoint3_8Request["params"]["sessionID"]
  readonly startMessageID?: Endpoint3_8Request["payload"]["startMessageID"]
  readonly endMessageID?: Endpoint3_8Request["payload"]["endMessageID"]
  readonly focus?: Endpoint3_8Request["payload"]["focus"]
  readonly keepRecentTurns?: Endpoint3_8Request["payload"]["keepRecentTurns"]
}
...
type Endpoint3_9Request = Parameters<RawClient["server.session"]["session.contextStats"]>[0]
...
const Endpoint3_9 = (raw: RawClient["server.session"]) => (input: Endpoint3_9Input) =>
  raw["session.contextStats"]({ params: { sessionID: input["sessionID"] } }).pipe(
    Effect.mapError(mapClientError),
    Effect.map((value) => value.data),
  )
...
const adaptGroup3 = (raw: RawClient["server.session"]) => ({
  ...
  compress: Endpoint3_8(raw),
  contextStats: Endpoint3_9(raw),
