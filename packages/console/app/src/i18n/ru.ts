...
export const dict = {
  ...
  "go.problem.body":
    "Мы стремимся сделать alphacode доступным для как можно большего числа людей. opencode Go - это недорогая подписка: $5 за первый месяц, затем $10/месяц. Она предоставляет щедрые лимиты и надежный доступ к самым мощным моделям с открытым исходным кодом.",
  "go.problem.subtitle": " ",
