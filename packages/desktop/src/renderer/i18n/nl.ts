export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van alphacode is gedownload. Wil je deze installeren en alphacode opnieuw starten?",
