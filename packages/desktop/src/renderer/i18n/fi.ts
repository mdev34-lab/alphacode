export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo alphacoden uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "alphacoden versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää alphacoden uudelleen?",
