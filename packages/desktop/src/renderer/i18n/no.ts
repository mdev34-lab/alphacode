export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av alphacode er lastet ned. Vil du installere den og starte på nytt?",
