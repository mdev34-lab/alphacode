export const dict = {
  ...
  "desktop.updater.none.message": "Stai già utilizzando l'ultima versione di alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "La versione {{version}} di alphacode è stata scaricata. Vuoi installarla e riavviare l'app?",
