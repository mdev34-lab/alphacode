export const dict = {
  ...
  "desktop.updater.none.message": "Folosești deja cea mai recentă versiune alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versiunea {{version}} alphacode a fost descărcată. Vrei să o instalezi și să repornești?",
