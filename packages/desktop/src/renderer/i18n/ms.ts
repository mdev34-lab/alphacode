export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terkini alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versi {{version}} alphacode telah dimuat turun, adakah anda ingin memasangnya dan melancarkan semula?",
