export const dict = {
  ...
  "desktop.updater.none.message": "Jau naudojate naujausią alphacode versiją",
  ...
  "desktop.updater.downloaded.prompt":
    "alphacode versija {{version}} atsisiųsta, ar norėtumėte ją įdiegti ir paleisti iš naujo?",
