export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} alphacode. Czy chcesz ją zainstalować i uruchomić ponownie?",
