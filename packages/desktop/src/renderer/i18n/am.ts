export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የalphacode ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከalphacode ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
