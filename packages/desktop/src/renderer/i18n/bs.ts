export const dict = {
  ...
  "desktop.updater.none.message": "Već koristiš najnoviju verziju alphacode-a",
  ...
  "desktop.updater.downloaded.prompt":
    "Verzija {{version}} alphacode-a je preuzeta. Želiš li da je instaliraš i ponovo pokreneš aplikaciju?",
