export const dict = {
  ...
  "desktop.updater.none.message": "Sie verwenden bereits die neueste Version von alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} von alphacode wurde heruntergeladen. Möchten Sie sie installieren und neu starten?",
