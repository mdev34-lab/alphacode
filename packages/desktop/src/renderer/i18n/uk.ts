export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} alphacode завантажено. Бажаєте встановити її та перезапустити?",
