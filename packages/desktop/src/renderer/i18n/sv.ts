export const dict = {
  ...
  "desktop.updater.none.message": "Du använder redan den senaste versionen av alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} av alphacode har laddats ned. Vill du installera den och starta om programmet?",
