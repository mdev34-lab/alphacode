export const dict = {
  ...
  "desktop.updater.none.message": "Tú brúkar longu nýggjastu útgávuna av alphacode.",
  ...
  "desktop.updater.downloaded.prompt":
    "Útgáva {{version}} av alphacode er heintað, vilt tú seta hana upp og seta hana í gongd aftur?",
