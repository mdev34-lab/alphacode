export const dict = {
  ...
  "desktop.updater.none.message": "Већ користите најновију верзију alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Верзија {{version}} од alphacode је преузета, да ли желите да је инсталирате и поново покренете?",
