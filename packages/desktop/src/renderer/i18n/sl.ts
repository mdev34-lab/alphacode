export const dict = {
  ...
  "desktop.updater.none.message": "Že uporabljate najnovejšo različico alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Različica {{version}} alphacode je bila prenesena, jo želite namestiti in znova zagnati?",
