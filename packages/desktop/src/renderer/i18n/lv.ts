export const dict = {
  ...
  "desktop.updater.none.message": "Jūs jau izmantojat jaunāko alphacode versiju",
  ...
  "desktop.updater.downloaded.prompt":
    "alphacode versija {{version}} ir lejupielādēta. Vai vēlaties to instalēt un palaist no jauna?",
