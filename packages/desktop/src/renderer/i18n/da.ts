export const dict = {
  ...
  "desktop.updater.none.message": "Du bruger allerede den nyeste version af alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} af alphacode er blevet downloadet. Vil du installere den og genstarte?",
