export const dict = {
  ...
  "desktop.updater.none.message": "Ju tashmë po përdorni versionin më të fundit të alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Versioni {{version}} i alphacode është shkarkuar, dëshironi ta instaloni dhe rinisni?",
