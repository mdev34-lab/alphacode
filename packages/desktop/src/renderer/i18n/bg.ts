export const dict = {
  ...
  "desktop.updater.none.message": "Вече използвате най-новата версия на alphacode",
  ...
  "desktop.updater.downloaded.prompt":
    "Версия {{version}} от alphacode е изтеглена. Искате ли да я инсталирате и рестартирате?",
