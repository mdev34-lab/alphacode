...
export const Definitions = {
  ...
  session_compress: keybind("none", "Compress finished parts of the session context"),
  ...
  permission_auto_toggle: keybind("<leader>y", "Toggle auto-approve (YOLO) mode"),
  ...
  tool_activity: keybind("ctrl+o", "Expand or collapse tool activity groups"),
...
export const CommandMap = {
  ...
  permission_auto_toggle: "permission.mode",
  ...
  tool_activity: "session.toggle.activity",
