...
const TIPS: Tip[] = [
  ...
  (shortcuts) => press(shortcuts.agentCycle(), "to cycle between Work and Plan agents"),
  ...
  "Create a plugin to prevent alphacode from reading sensitive files",
  "Use {highlight}alphacode run{/highlight} for non-interactive scripting",
  "Use {highlight}alphacode --continue{/highlight} to resume the last session",
  "Use {highlight}alphacode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}alphacode serve{/highlight} for headless API access",
  "Use {highlight}alphacode run --attach{/highlight} to connect to a running server",
  "Run {highlight}alphacode upgrade{/highlight} to update to the latest version",
  "Run {highlight}alphacode auth list{/highlight} to see all configured providers",
  "Run {highlight}alphacode agent create{/highlight} for guided agent creation",
  "Run {highlight}alphacode github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}alphacode debug config{/highlight} to troubleshoot configuration",
