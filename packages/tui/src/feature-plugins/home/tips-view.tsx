...
const TIPS: Tip[] = [
  ...
  "Create a plugin to prevent silvercode from reading sensitive files",
  "Use {highlight}silvercode run{/highlight} for non-interactive scripting",
  "Use {highlight}silvercode --continue{/highlight} to resume the last session",
  "Use {highlight}silvercode run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}silvercode serve{/highlight} for headless API access",
  "Use {highlight}silvercode run --attach{/highlight} to connect to a running server",
  "Run {highlight}silvercode upgrade{/highlight} to update to the latest version",
  "Run {highlight}silvercode auth list{/highlight} to see all configured providers",
  "Run {highlight}silvercode agent create{/highlight} for guided agent creation",
  "Run {highlight}silvercode github install{/highlight} to set up the GitHub workflow",
