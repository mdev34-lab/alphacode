...
const TIPS: Tip[] = [
  ...
  "Run {highlight}opencode serve{/highlight} for headless API access to alphacode",
  ...
  "Use {highlight}/connect{/highlight} with alphacode Zen for curated, tested models",
