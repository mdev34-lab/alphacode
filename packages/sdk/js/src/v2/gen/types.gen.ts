...
export type Event =
  ...
  | EventSessionNextCompressCommitted
...
export type GlobalEvent = {
  ...
  payload:
    ...
    | SyncEventSessionNextCompressCommitted
...
export type SyncEventSessionNextCompressCommitted = {
  type: "sync"
  id: string
  syncEvent: {
    type: "session.next.compress.committed.1"
    id: string
    seq: number
    aggregateID: string
    data: {
...
export type SessionNextCompressCommitted = {
  id: string
  metadata?: {
    [key: string]: unknown
  }
...
export type EventSessionNextCompressCommitted = {
  id: string
  type: "session.next.compress.committed"
  properties: {
    timestamp: number
...
export type SessionResumeResponses = {
  /**
   * Whether the agent loop was driven
   */
  200: boolean
}
