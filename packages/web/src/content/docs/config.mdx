...
OpenCode injects a short STE-lite reply style into **user-facing chat** generations. Internal calls — compaction, titles, summaries, and structured output — do not receive it.
