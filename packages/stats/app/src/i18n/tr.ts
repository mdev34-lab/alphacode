export const dict = {
  ...
  "app.description":
    "alphacode kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  ...
  "home.topModelsDescription": "alphacode genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz alphacode kullanıcıları.",
  ...
  "lab.description":
    "alphacode'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  ...
  "model.description":
    "{{model}} için alphacode kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda alphacode kullanımı görünür.",
  "model.unranked": "Geçen haftaki alphacode kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki alphacode kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde alphacode kullanımı yok.",
  ...
  "model.overviewDescription": "Son alphacode tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz alphacode kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük alphacode token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz alphacode kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama alphacode oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan alphacode model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen alphacode coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son alphacode token hacmine göre yakındaki modeller.",
