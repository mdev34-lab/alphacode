export const dict = {
  "app.title": "Yapay Zeka Model Kullanım Sıralamaları | alphacode Data",
  "app.description":
    "alphacode Go kullanımını yapay zeka modelleri genelinde keşfedin: token hacmi, sıralamalar, pazar payı, token fiyatlandırması, oturum maliyeti, önbellek oranı ve coğrafi dağılımlar.",
  "app.unfurlAlt": "Koyu desenli arka plan üzerinde alphacode Data logosu",
  ...
  "header.githubAria": "GitHub'da alphacode'a yıldız ver",
  "header.github": "GitHub",
  "header.tryalphacode": "alphacode'u dene",
  ...
  "footer.homeAria": "alphacode ana sayfası",
  ...
  "home.topModelsDescription": "alphacode Go genelinde model kullanımı.",
  ...
  "home.uniqueUsersDescription": "Modele göre günlük benzersiz alphacode Go kullanıcıları.",
  ...
  "lab.title": "{{lab}} Yapay Zeka Model Kullanımı ve Sıralamaları | alphacode Data",
  "lab.description":
    "alphacode Go'da kullanılan {{lab}} modellerini karşılaştırın: token kullanımı, model sıralamaları, bağlam pencereleri, yayın tarihleri, maliyetler ve modele özel veriler.",
  "lab.loadingTitle": "Model Laboratuvarı",
  "lab.loadingDescription": "Model kullanılabilirliği ve son alphacode kullanımı okunuyor.",
  "lab.notFound": "Bu laboratuvarla eşleşen model yok.",
  "lab.heroPrefix": "alphacode'da kullanılan {{count}} {{lab}} modelini keşfedin",
  ...
  "lab.shareOfUsage": "Son alphacode kullanımının {{share}} kadarı",
  "lab.usageTitle": "{{lab}} token kullanımı",
  "lab.usageDescription": "Son iki ayda günlük alphacode token hacmi.",
  ...
  "lab.usage": "Kullanım",
  "lab.share": "Pay",
  "model.title": "{{model}} Kullanımı, Maliyeti ve Sırası | alphacode Data",
  "model.description":
    "{{model}} için alphacode Go kullanım verilerini görüntüleyin: token hacmi, haftalık sıra, token karışımı, maliyetler, önbellek oranı, oturumlar, coğrafi dağılımlar ve benzer modeller.",
  ...
  "model.catalogFallback":
    "Paylaşılan model dizininden model bilgileri. Bu modelde etkinlik olduğunda alphacode Go kullanımı görünür.",
  "model.unranked": "Geçen haftaki alphacode Go kullanımında sıralanmamış",
  "model.ranked": "Geçen haftaki alphacode Go kullanımında #{{rank}} sırada",
  ...
  "model.noCurrentUsage": "Geçerli veri penceresinde alphacode Go kullanımı yok.",
  ...
  "model.overviewDescription": "Son alphacode Go tokenları, benzersiz kullanıcılar ve pazar konumu.",
  "model.noSummaryTitle": "Kullanım özeti yok",
  "model.noSummaryDescription": "Bu modelde henüz alphacode Go kullanım satırı yok.",
  ...
  "model.usageDescription": "Son iki aylık pencerede günlük alphacode Go token hacmi.",
  ...
  "model.usersDescription": "Son iki aylık pencerede günlük benzersiz alphacode Go kullanıcıları.",
  ...
  "model.efficiencyDescription": "Maliyet, önbellek davranışı ve ortalama alphacode Go oturum yapısı.",
  ...
  "model.geoDescription": "Ülkeye göre kullanılan alphacode Go model tokenları.",
  "model.noGeoTitle": "Coğrafi veri yok",
  "model.noGeoDescription": "Bu modelle eşleşen alphacode Go coğrafi satırı yok.",
  "model.worldMap": "Ülkeye göre model token kullanımının dünya haritası",
  "model.peersDescription": "Son alphacode Go token hacmine göre yakındaki modeller.",
