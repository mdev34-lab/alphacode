export const dict = {
  ...
  "app.description":
    "Esplora l'utilizzo di alphacode nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in alphacode.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di alphacode per modello.",
  ...
  "lab.description":
    "Confronta i modelli {{lab}} usati in alphacode, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  ...
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in alphacode, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di alphacode appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo alphacode della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo alphacode della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di alphacode nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di alphacode, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di alphacode.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token alphacode nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di alphacode nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione alphacode.",
  ...
  "model.geoDescription": "Token del modello alphacode usati per paese.",
  "model.noGeoTitle": "Nessun dato geografico",
  "model.noGeoDescription": "Nessuna riga geografica alphacode corrispondeva a questo modello.",
  "model.worldMap": "Mappa mondiale dell'utilizzo dei token del modello per paese",
  "model.peersDescription": "Modelli vicini per volume recente di token alphacode.",
