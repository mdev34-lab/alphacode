export const dict = {
  "app.title": "Rankingi użycia modeli AI | alphacode Data",
  "app.description":
    "Przeglądaj użycie alphacode Go w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny alphacode Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę alphacode na GitHub",
  "header.github": "GitHub",
  "header.tryalphacode": "Wypróbuj alphacode",
  ...
  "footer.homeAria": "Strona główna alphacode",
  ...
  "home.topModelsDescription": "Użycie modeli w alphacode Go.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy alphacode Go według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | alphacode Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w alphacode Go, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia alphacode.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w alphacode",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia alphacode",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów alphacode z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | alphacode Data",
  "model.description":
    "Zobacz dane użycia {{model}} w alphacode Go, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie alphacode Go pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu alphacode Go z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu alphacode Go z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia alphacode Go w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny alphacode Go, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia alphacode Go.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów alphacode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy alphacode Go w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji alphacode Go.",
  ...
  "model.geoDescription": "Tokeny modelu alphacode Go użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne alphacode Go nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów alphacode Go.",
