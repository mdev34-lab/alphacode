export const dict = {
  ...
  "app.description":
    "Przeglądaj użycie alphacode w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  ...
  "home.topModelsDescription": "Użycie modeli w alphacode.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy alphacode według modelu.",
  ...
  "lab.description":
    "Porównaj modele {{lab}} używane w alphacode, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  ...
  "model.description":
    "Zobacz dane użycia {{model}} w alphacode, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie alphacode pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu alphacode z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu alphacode z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia alphacode w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny alphacode, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia alphacode.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów alphacode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy alphacode w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji alphacode.",
  ...
  "model.geoDescription": "Tokeny modelu alphacode użyte według kraju.",
  "model.noGeoTitle": "Brak danych geograficznych",
  "model.noGeoDescription": "Żadne wiersze geograficzne alphacode nie pasowały do tego modelu.",
  "model.worldMap": "Mapa świata użycia tokenów modelu według kraju",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów alphacode.",
