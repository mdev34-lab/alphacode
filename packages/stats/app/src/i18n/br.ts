export const dict = {
  ...
  "app.description":
    "Explore o uso do alphacode em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no alphacode.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do alphacode por modelo.",
  ...
  "lab.description":
    "Compare modelos da {{lab}} usados no alphacode, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  ...
  "model.description":
    "Veja dados de uso de {{model}} no alphacode, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no alphacode aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do alphacode da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do alphacode da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do alphacode na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do alphacode, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do alphacode.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do alphacode na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do alphacode na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do alphacode.",
  ...
  "model.geoDescription": "Tokens do modelo alphacode usados por país.",
  "model.noGeoTitle": "Sem dados geográficos",
  "model.noGeoDescription": "Nenhuma linha geográfica do alphacode correspondeu a este modelo.",
  "model.worldMap": "Mapa-múndi do uso de tokens do modelo por país",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do alphacode.",
