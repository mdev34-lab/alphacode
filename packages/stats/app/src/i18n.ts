...
const en = {
  "app.title": "AI Model Usage Rankings | alphacode Data",
  "app.description":
    "Explore alphacode Go usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "alphacode Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star alphacode on GitHub",
  "header.github": "GitHub",
  "header.tryalphacode": "Try alphacode",
  ...
  "footer.homeAria": "alphacode home",
  ...
  "home.topModelsDescription": "Usage of models across alphacode Go.",
  ...
  "home.uniqueUsersDescription": "Daily unique alphacode Go users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | alphacode Data",
  "lab.description":
    "Compare {{lab}} models used in alphacode Go, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent alphacode usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in alphacode",
  ...
  "lab.shareOfUsage": "{{share}} of recent alphacode usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | alphacode Data",
  "model.description":
    "View {{model}} alphacode Go usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. alphacode Go usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's alphacode Go usage",
  "model.ranked": "Ranked #{{rank}} across last week's alphacode Go usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No alphacode Go usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no alphacode Go usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.geoDescription": "alphacode Go model tokens used by country.",
  "model.noGeoTitle": "No geo data",
  "model.noGeoDescription": "No alphacode Go geo rows matched this model.",
  "model.worldMap": "World map of model token usage by country",
  "model.peersDescription": "Nearby models by recent alphacode Go token volume.",
