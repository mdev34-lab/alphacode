...
brew install mdev34-lab/alphacode/alphacode # macOS e Linux (recomendado, sempre atualizado)
brew install alphacode              # macOS e Linux (fórmula oficial do brew, atualiza menos)
sudo pacman -S alphacode            # Arch Linux (Stable)
paru -S alphacode-bin               # Arch Linux (Latest from AUR)
mise use -g alphacode               # qualquer sistema
nix run nixpkgs#alphacode           # ou github:mdev34-lab/alphacode para a branch dev mais recente
```
...
O alphacode também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/mdev34-lab/alphacode/releases) ou em [alphacode.ai/download](https://github.com/mdev34-lab/alphacode).
