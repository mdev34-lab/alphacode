...
Το alphacode είναι επίσης διαθέσιμο ως εφαρμογή. Κατέβασε το απευθείας από τη [σελίδα εκδόσεων](https://github.com/mdev34-lab/alphacode/releases) ή το [GitHub](https://github.com/mdev34-lab/alphacode).
